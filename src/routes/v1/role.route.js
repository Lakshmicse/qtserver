...
router.route('/:roleId').get(roleController.getRole).patch(roleController.updateRole).delete(roleController.deleteRole);
router.route('/search/:searchId').get(auth('getRoles'), roleController.getroleBySearch);
router.route('/resetPassword/:roleId').get(auth('getRoles'), roleController.getRole).patch(roleController.updateRole);
